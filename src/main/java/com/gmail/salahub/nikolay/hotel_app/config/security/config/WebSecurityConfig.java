...
import com.gmail.salahub.nikolay.hotel_app.config.security.handler.AppAccessDeniedHandler;
import com.gmail.salahub.nikolay.hotel_app.config.security.handler.LoginSuccessHandler;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                .antMatchers("/private/hotel/**")
                .hasAuthority(ADMINISTRATOR_STRING_ROLE_VALUE)
                .antMatchers("/public/hotel/**")
                .hasAuthority(USER_STRING_ROLE_VALUE)
                .and()
                .formLogin()
                .loginPage("/login")
